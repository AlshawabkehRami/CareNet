...
public class GroupsManagement extends BasePage {
    ...
    String PageLinkLocator = "rptApplications_ctl04_rptSystem_ctl00_rptModule_ctl05_rptForms_ctl03_lblfontFrm";
    ...
    public void navigateToGroupsManagementPage() throws InterruptedException {
        ...
        Reporter.log("Click on Groups Management  Page link ");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_lblPageName"))).getText();
        String ExpectedResult = "Groups Management";
        Assert.assertEquals(ActualResult, ExpectedResult, " Groups Management Page not opened Properly");
    }
