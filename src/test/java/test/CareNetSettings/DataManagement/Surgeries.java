...
public class Surgeries extends BasePage {
    ...
    public void navigateToSurgeriesPage() throws InterruptedException {
        ...
        Reporter.log("Click on Surgeries page link");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_ContentPlaceHolder1_lblSurgeriesList"))).getText();
        String ExpectedResult = "Surgeries";
        Assert.assertEquals(ActualResult, ExpectedResult, "Surgeries Page not opened Properly");
    }
