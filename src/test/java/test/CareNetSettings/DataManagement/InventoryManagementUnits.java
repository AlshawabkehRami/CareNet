...
public class InventoryManagementUnits extends BasePage {
    ...
    public void navigateToInventoryManagementUnitsPage() throws InterruptedException {
        ...
        Reporter.log("Navigate To Inventory Management Units Page");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_ContentPlaceHolder1_lblSearchArea"))).getText();
        String ExpectedResult = "Search";
        Assert.assertEquals(ActualResult, ExpectedResult, "Inventory Measurement Units Page not opened Properly");
    }
