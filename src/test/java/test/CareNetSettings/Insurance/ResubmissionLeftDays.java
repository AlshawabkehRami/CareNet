...
public class ResubmissionLeftDays extends BasePage {
    ...
    String PageLinkLocator = "rptApplications_ctl04_rptSystem_ctl00_rptModule_ctl06_rptForms_ctl11_lblfontFrm";
    ...
    public void navigateToResubmissionLeftDaysPage() throws InterruptedException {
        ...
        Reporter.log("Click on Resubmission Left Days   Page  link ");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_lblPageName"))).getText();
        String ExpectedResult = "Resubmission Left Days";
        Assert.assertEquals(ActualResult, ExpectedResult, "Resubmission Left Days  Page not opened Properly");
    }
