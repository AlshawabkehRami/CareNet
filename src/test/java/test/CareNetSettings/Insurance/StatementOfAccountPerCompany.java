...
public class StatementOfAccountPerCompany extends BasePage {
    ...
    public void navigateToStatementOfAccountPerCompanyPage() throws InterruptedException {
        ...
        click("id", StatementOfAccountPerCompanyPageID, browser, "Click on Statement Of Account Per Company   Page  link ");
        assertByPageName("Statement Of Account Per Company");
    }
