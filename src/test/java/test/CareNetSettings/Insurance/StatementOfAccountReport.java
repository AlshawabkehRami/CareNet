...
public class StatementOfAccountReport extends BasePage {
    ...
    String PageLinkLocator = "rptApplications_ctl04_rptSystem_ctl00_rptModule_ctl06_rptForms_ctl15_lblfontFrm";
    ...
    public void navigateToStatementOfAccountReportPage() throws InterruptedException {
        ...
        Reporter.log("Click on Statement Of Account Report   Page  link ");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_lblPageName"))).getText();
        String ExpectedResult = "Statement Of Account Report";
        Assert.assertEquals(ActualResult, ExpectedResult, "Statement Of Account Report  Page not opened Properly");
    }
