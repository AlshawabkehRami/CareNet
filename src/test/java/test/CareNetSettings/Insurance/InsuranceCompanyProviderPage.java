...
public class InsuranceCompanyProviderPage extends BasePage {
    WebDriver driver;
    WebDriver OpenDriver;
    String PageLinkLocator = "rptApplications_ctl04_rptSystem_ctl00_rptModule_ctl06_rptForms_ctl14_lblfontFrm";
    ...
    public void navigateToInsuranceCompanyProviderPagePage() throws InterruptedException {
        ...
        String ExpectedResult = "InsuranceCompanyProviderPage";
        Assert.assertEquals(ActualResult, ExpectedResult, "InsuranceCompanyProviderPage  Page not opened Properly");
    }
