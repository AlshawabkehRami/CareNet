...
public class MachineType extends BasePage {
    ...
    public void navigateToMachineType() throws InterruptedException {
        ...
        Reporter.log("Click on Machine Type Page Link");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_lblPageName"))).getText();
        System.out.print(ActualResult);
        String ExpectedResult = "Machine Type";
        Assert.assertEquals(ActualResult, ExpectedResult, "Machine Type Page not opened Properly");
