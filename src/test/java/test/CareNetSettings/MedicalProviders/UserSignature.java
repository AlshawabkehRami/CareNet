...
public class UserSignature extends BasePage {
    ...
    String PageLinkLocator = "rptApplications_ctl04_rptSystem_ctl00_rptModule_ctl01_rptForms_ctl05_lblfontFrm";
    ...
    public void navigateToUserSignature() throws InterruptedException {
        ...
        Reporter.log("Click on UserSignature Page Link");
        Wait = new WebDriverWait(OpenDriver, 20);
        String ActualResult = Wait.until(ExpectedConditions.visibilityOfElementLocated
                (By.id("ctl00_lblPageName"))).getText();
        System.out.print(ActualResult);
        String ExpectedResult = "User Signature";
        Assert.assertEquals(ActualResult, ExpectedResult, "UserSignature Page not opened Properly");
